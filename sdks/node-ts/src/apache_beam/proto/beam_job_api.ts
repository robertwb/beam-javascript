 ...
 * to deduplicate based on the name of the job. Throws error UNKNOWN for all
 * other issues
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.PrepareJobRequest
 */
...
export interface PrepareJobResponse {
   ...
   * preparationId is used to run the job.
   *
   * @generated from protobuf field: string preparation_id = 1;
   */
  preparationId: string;
  /**
   * An endpoint which exposes the Beam Artifact Staging API. Artifacts used by
   * the job should be staged to this endpoint, and will be available during job
   * execution.
   *
   ...
   * artifact staging session with the artifact staging service.
   *
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.RunJobRequest
 */
export interface RunJobRequest {
  /**
   * (required) The ID provided by an earlier call to prepare. Runs the job. All
   * prerequisite tasks must have been completed.
   *
   * @generated from protobuf field: string preparation_id = 1;
   */
  preparationId: string;
   ...
   * retrieval_token returned from the CommitManifestResponse.
   *
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.JobInfo
 */
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.GetJobsRequest
 */
...
/**
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.JobStateEvent
 */
...
/**
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.JobMessage
 */
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.JobState
 */
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.MetricResults
 */
 ...
 * runner. It will be used by the SDK client to validate the options specified
 * by or list available options to the user. Throws error
 * GRPC_STATUS_UNAVAILABLE if server is down
 *
 * @generated from protobuf message
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.job_management.v1.PipelineOptionType
 */
...
export interface DescribePipelineOptionsResponse {
   ...
   *
   * @generated from protobuf field: repeated
   * org.apache.beam.model.job_management.v1.PipelineOptionDescriptor options =
   * 1;
   */
