...
export interface IBeamFnControl extends grpc.UntypedServiceImplementation {
   ...
   * of work.
   *
   * @generated from protobuf rpc: Control(stream
   ...
   * GetProcessBundleDescriptor(org.apache.beam.model.fn_execution.v1.GetProcessBundleDescriptorRequest)
...
export interface IBeamFnData extends grpc.UntypedServiceImplementation {
   ...
   *
   * @generated from protobuf rpc: Data(stream
...
export interface IBeamFnState extends grpc.UntypedServiceImplementation {
   ...
   *
   * @generated from protobuf rpc: State(stream
...
export interface IBeamFnLogging extends grpc.UntypedServiceImplementation {
   ...
   *
   * @generated from protobuf rpc: Logging(stream
 ...
 * org.apache.beam.model.fn_execution.v1.BeamFnExternalWorkerPool.
 *
 * Usage: Implement the interface IBeamFnExternalWorkerPool and add to a grpc
 * server.
 *
 * ```typescript
 * const server = new grpc.Server();
...
export interface IBeamFnWorkerStatus extends grpc.UntypedServiceImplementation {
  /**
   * @generated from protobuf rpc: WorkerStatus(stream
