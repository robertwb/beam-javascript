...
class GetProvisionInfoRequest$Type extends MessageType<GetProvisionInfoRequest> {
  ...
  create(
    value?: PartialMessage<GetProvisionInfoRequest>
  ...
  internalBinaryRead(
    ...
    target?: GetProvisionInfoRequest
  ): GetProvisionInfoRequest {
...
class GetProvisionInfoResponse$Type extends MessageType<GetProvisionInfoResponse> {
  ...
  create(
    value?: PartialMessage<GetProvisionInfoResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetProvisionInfoResponse
  ): GetProvisionInfoResponse {
  ...
  internalBinaryWrite(
    ...
    /* org.apache.beam.model.fn_execution.v1.ProvisionInfo info = 1; */
    if (message.info)
      ProvisionInfo.internalBinaryWrite(
        message.info,
 ...
 */
export const ProvisionService = new ServiceType(
  "org.apache.beam.model.fn_execution.v1.ProvisionService",
  [
    {
