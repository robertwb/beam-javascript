...
export class RemoteJobServiceClient {
   ...
   * @param {optional} transport By default, GrpcTransport is used. Supply an
   *     RpcTransport to override.
   * @param channelCredentials ChannelCredentials.createInsecure() by default.
