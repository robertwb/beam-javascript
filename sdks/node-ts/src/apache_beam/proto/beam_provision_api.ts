...
// @generated from protobuf file "beam_provision_api.proto" (package
 ...
 * org.apache.beam.model.fn_execution.v1.GetProvisionInfoRequest
 */
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.fn_execution.v1.GetProvisionInfoResponse
 */
 ...
 *
 * @generated from protobuf message
 * org.apache.beam.model.fn_execution.v1.ProvisionInfo
 */
export interface ProvisionInfo {
   ...
   * org.apache.beam.model.pipeline.v1.ArtifactInformation dependencies = 11;
   */
...
// optimized methods
class GetProvisionInfoRequest$Type extends
    MessageType<GetProvisionInfoRequest> {
  constructor() {
    super('org.apache.beam.model.fn_execution.v1.GetProvisionInfoRequest', []);
  }
  create(value?: PartialMessage<GetProvisionInfoRequest>):
  ...
  internalBinaryRead(
      ...
      target?: GetProvisionInfoRequest): GetProvisionInfoRequest {
    return target ?? this.create();
  }
  internalBinaryWrite(
      message: GetProvisionInfoRequest, writer: IBinaryWriter,
...
// @generated message type with reflection information, may provide speed
// optimized methods
class GetProvisionInfoResponse$Type extends
    MessageType<GetProvisionInfoResponse> {
  constructor() {
    super(
        'org.apache.beam.model.fn_execution.v1.GetProvisionInfoResponse',
        [{no: 1, name: 'info', kind: 'message', T: () => ProvisionInfo}]);
  }
  create(value?: PartialMessage<GetProvisionInfoResponse>):
  ...
  internalBinaryRead(
      reader: IBinaryReader, length: number, options: BinaryReadOptions,
      target?: GetProvisionInfoResponse): GetProvisionInfoResponse {
    let message = target ?? this.create(), end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* org.apache.beam.model.fn_execution.v1.ProvisionInfo info */ 1:
          message.info = ProvisionInfo.internalBinaryRead(
              reader, reader.uint32(), options, message.info);
          break;
        default:
  ...
  internalBinaryWrite(
      message: GetProvisionInfoResponse, writer: IBinaryWriter,
      options: BinaryWriteOptions): IBinaryWriter {
    /* org.apache.beam.model.fn_execution.v1.ProvisionInfo info = 1; */
    if (message.info)
      ProvisionInfo
          .internalBinaryWrite(
              message.info, writer.tag(1, WireType.LengthDelimited).fork(),
              options)
          .join();
    let u = options.writeUnknownFields;
    if (u !== false)
...
class ProvisionInfo$Type extends MessageType<ProvisionInfo> {
  ...
  internalBinaryRead(
      reader: IBinaryReader, length: number, options: BinaryReadOptions,
      target?: ProvisionInfo): ProvisionInfo {
    let message = target ?? this.create(), end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        ...
        case /* org.apache.beam.model.pipeline.v1.ApiServiceDescriptor
                status_endpoint */
            7:
          message.statusEndpoint = ApiServiceDescriptor.internalBinaryRead(
              reader, reader.uint32(), options, message.statusEndpoint);
          break;
        case /* org.apache.beam.model.pipeline.v1.ApiServiceDescriptor
                logging_endpoint */
            8:
  ...
  private binaryReadMap13(
      map: ProvisionInfo['metadata'], reader: IBinaryReader,
      options: BinaryReadOptions): void {
    let len = reader.uint32(), end = reader.pos + len,
        key: keyof ProvisionInfo['metadata']|undefined,
        val: ProvisionInfo['metadata'][any]|undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
              'unknown map entry field for field org.apache.beam.model.fn_execution.v1.ProvisionInfo.metadata');
      }
    }
    map[key ?? ''] = val ?? '';
  }
  internalBinaryWrite(
      message: ProvisionInfo, writer: IBinaryWriter,
      options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* org.apache.beam.model.pipeline.v1.ApiServiceDescriptor status_endpoint =
     * 7; */
    if (message.statusEndpoint)
      ApiServiceDescriptor
          .internalBinaryWrite(
              message.statusEndpoint,
    ...
    for (let i = 0; i < message.runnerCapabilities.length; i++)
      writer.tag(12, WireType.LengthDelimited)
          .string(message.runnerCapabilities[i]);
    /* map<string, string> metadata = 13; */
    for (let k of Object.keys(message.metadata))
      writer.tag(13, WireType.LengthDelimited)
          .fork()
    ...
    for (let i = 0; i < message.siblingWorkerIds.length; i++)
      writer.tag(14, WireType.LengthDelimited)
          .string(message.siblingWorkerIds[i]);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
          this.typeName, message, writer);
...
export const ProvisionService =
    new ServiceType('org.apache.beam.model.fn_execution.v1.ProvisionService', [{
                      name: 'GetProvisionInfo',
                      options: {},
                      I: GetProvisionInfoRequest,
                      O: GetProvisionInfoResponse
                    }]);
